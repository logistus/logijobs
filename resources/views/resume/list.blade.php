...
<div class="ui container segment grid">
    <div class="row">
        ...
        <div class="twelve wide computer sixteen wide mobile column">
            <button type="button" style="margin-bottom: 10px;" class="ui right floated green button" id="btn-create-resume">{{ __('commons.create_resume') }}</button>
                ...
                @foreach ($user_resumes as $user_resume)
                    <div class="card resume_{{ $user_resume->id }}" style="background-color: #fafafa;">
                        <div class="content">
                            ...
                            <div class="header"><a href="/resume/{{ $user_resume->id }}">{{ $user_resume->name }}</a></div>
                            <div class="meta">
                        ...
                        <div class="extra content">
                            <button class="ui tiny red button delete-resume" type="button" id="{{ $user_resume->id }}">{{ __('commons.delete') }}</button>
                            <div class="ui toggle checkbox">
                                <input type="checkbox" tabindex="0" class="hidden" id="{{ $user_resume->id }}"
    ...
    $(function() {
        ...
        $("#create_resume").click(function(){
            ...
            if (name == "" || language == undefined) {
                ...
                $.post("/resume", {name: name, language: language, _token: '{{csrf_token()}}'}, function(data){
                    if (data){
